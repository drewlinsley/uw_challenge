...
class data_processing(object):
    def __init__(self):
        self.name = 'curv_contour_segments_length_14_full'
        self.output_name = 'curv_contour_segments_length_14_full'
        self.data_name = 'curv_contour_length_14'
        self.img_dir = 'img'
        self.seg_dir = 'seg'
        self.contour_dir = '/media/data_cifs/pathfinder_seg/'
    ...
    def get_data(self):
        ...
        positive_meta = np.load(
            os.path.join(
                ...
                self.data_name,
                self.meta))
        ims = self.list_files(positive_meta, self.data_name, cat=0)
