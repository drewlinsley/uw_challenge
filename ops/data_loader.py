...
def image_augmentations(
    ...
    if data_augmentations is not None:
        ...
        if 'sgl_label' in data_augmentations:
        ...
        if 'rgb2gray' in data_augmentations and im_size_check:
            image = tf.image.rgb_to_grayscale(image)
        ...
        if 'rot_image_label' in data_augmentations and im_size_check:
            max_theta = 30.
            angle_rad = (max_theta / 180.) * math.pi
            angles = tf.random_uniform([], -angle_rad, angle_rad)
            transform = tf.contrib.image.angles_to_projective_transforms(
        ...
        if 'rc_image_label' in data_augmentations and im_size_check:
            assert len(image.get_shape()) == 3, '4D not implemented yet.'
            image, label = crop_image_label(
                ...
                crop='random')
        if 'cc_image_label' in data_augmentations and im_size_check:
            assert len(image.get_shape()) == 3, '4D not implemented yet.'
            image, label = crop_image_label(
                image=image,
                label=label,
        ...
        if 'jk_resize' in data_augmentations and im_size_check:
            ...
            print 'Applying area resize.'
        if 'res_and_crop' in data_augmentations and im_size_check:
            ...
            image = center_crop(image, model_input_image_size)
            print 'Applying area resize.'
        if 'res_nn' in data_augmentations and im_size_check:
            assert len(image.get_shape()) == 3, '4D not implemented yet.'
            if len(model_input_image_size) > 2:
                model_input_image_size = model_input_image_size[:2]
            image = resize_image_label(
        ...
        if 'res_image_label' in data_augmentations and im_size_check:
            assert len(image.get_shape()) == 3, '4D not implemented yet.'
            if len(model_input_image_size) > 2:
                model_input_image_size = model_input_image_size[:2]
            image = resize_image_label(
        ...
        elif 'res_nn_image_label' in data_augmentations and im_size_check:
            assert len(image.get_shape()) == 3, '4D not implemented yet.'
            if len(model_input_image_size) > 2:
                model_input_image_size = model_input_image_size[:2]
            image = resize_image_label(
        ...
        if 'bfloat16_image' in data_augmentations:
            image = tf.cast(image, tf.bfloat16)
        if 'bfloat16_label' in data_augmentations:
            label = tf.cast(label, tf.bfloat16)
        if 'hfloat16_image' in data_augmentations:
            image = tf.cast(image, tf.float16)
        if 'hfloat16_label' in data_augmentations:
